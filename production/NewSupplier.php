...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;">
      ...
      <!--start of the form-->
       <form role="form" method="post" action="ConnectionNewSupplier.php">
        <div class="form-group">
          <label>Supplier Name:</label>
          <input type="text" class="form-control" autofocus="on" name="name" autocomplete="off">
        </div>
        <div class="form-group">
          <label>Adderss:</label>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="contactper" autocomplete="off">
        </div>
    ...
    <div class="col-sm-6">
      ...
      <!--start of the tabele--><div style="height:550px;overflow:auto;">
        ...
        <th class="tablecol3">Tel.</th>
        <th class="tablecol3">Fax</th>
        <th class="tablecol3">Contact Person</th>
        </tr>
      </thead>
         <tbody>
            <?php include 'connection.php'; $result = mysqli_query($conn,"SELECT * FROM supplier WHERE CompanyID = $company ORDER BY Name");
              while($row=mysqli_fetch_array($result)) {

                echo "<tr><td>".$row[1]."</td><td>".$row[2]."</td><td>".$row[5]."</td><td>".$row[3]."</td><td>".$row[4]."</td><td>".$row[6]."</td></tr>";
              }
             ?>
          </tbody>
        </table>
