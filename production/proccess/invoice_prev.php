            ...
            <table style="width:800px;">
              ...
              <tr>
                ...
                <td colspan="2" style="text-align:center;border-bottom: 1px solid">
                  <p style="font-size:17px;text-transform: uppercase;"><b>INVOICE</b></p>
                  </td>
      ...
      <table class="table-striped table-bordered" style="width:800px;">
        <thead>
          <tr>
            ...
            <th style='text-align:right;font-size:12px;'>Amount (Rs.)</th>

            <!-- <th style='text-align:right;font-size:10px;'>Free Issue</th> -->
            <th style='text-align:right;font-size:12px;text-align: center;'>Discount(Rs.)</th>
            <th style='text-align:right;font-size:12px;'>Value(Rs.)</th>
        ...
        <tbody>
          <tr>
            ...
            foreach ($invoice_inventorys as $invoice_inventory) {
              ...
              echo "<td style='font-size:14px;padding:2px;text-align:center;'>" . $invoice_inventory->inventory_id()->product_id()->brand . "</td>";
              ...
              echo "<td style='text-align:right;font-size:14px;'>" . number_format($uPrice,2) . "</td>";
              ...
              echo "<td style='text-align:right;font-size:14px;text-align:center;'>" . $unit_discount_str . "%</td>";

              // echo "<td style='text-align:right;font-size:10px;'>" . $invoice_inventory->gross_amount . "</td>";
              echo "<td style='text-align:right;font-size:14px;'>" . number_format($uPrice*$value*$invoice_inventory->qty,2) . "</td>";
              echo "</tr>";
            }
            ?>
          </tr>
