          ...
          <div class="col-sm-12 text-left">
            ...
            <table class="table table-striped" width="100%" style="font-size:12px;">
              ...
              <tbody>
                ...
                if(isset($_GET['id'])){
                  $inv =  $_GET['id'];
                  $result = mysqli_query($conn,"SELECT * FROM po_sub WHERE ID = $inv ");
                  ...
                  $SubCount = 0;
                  $result = mysqli_query($conn,"SELECT * FROM sub_po_sub WHERE PoID = '$invoice' ");
                  while($row = mysqli_fetch_array($result)){
                    GLOBAL $SubCount;
                    $SubCount =  $SubCount + 1;
                  }
                  ...
                  while($steps<=$SubCount){
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM sub_po_sub WHERE PoID = '$invoice' LIMIT $steps");
                    while($row = mysqli_fetch_array($result)){
                  ...
                  echo "<tr><td></td><td></td><td></td><td></td><td>TOTAL</td><td>Rs. ".number_format($pototal,2)."</td></tr>";
