...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" style="margin-top:10px;background-color: #F8F8F8;"> 
      ...
      <!--start of the form-->
       <form role="form" method="post" action="ConnectionRouteAllocation.php">
        <div class="form-group">
          <label>Date:</label>
          <input type="text" class="form-control" id="datepicker" name="routedate" placeholder="Date" autocomplete="off" autofocus="on">
        </div>
        <div class="form-group">
          <label>Route:</label>
        ...
        <div class="form-group">
          <label>Employee Who Place The Order:</label>
          <select class="form-control" name="repname" >
      ...
      <!--end of the form-->
       ...
       <div class="col-sm-6" style="height:500px;overflow:auto;">
        <div id="txtHint" style="background-color:#eee;"><b>
          <table class="table table-striped">
            ...
            <tbody>
              ...
              function name($id){
                include 'connection.php';
                $result = mysqli_query($conn,"SELECT * FROM user_profile WHERE Prof_ID = $id ");
                while($row = mysqli_fetch_array($result)){
                  GLOBAL $name;
                    $name = $row[1];
                }
              ...
              $result = mysqli_query($conn,"SELECT * FROM route WHERE AllocatedDate = '$AllocatedDate' ");
              while($row = mysqli_fetch_array($result)){
                echo "<tr>";
                echo "<td>".$row[3]."</td>";
                echo "<td>".name($row[2])."</td>";
                echo "<td>".$row[1]."</td>";
                echo "</tr>";
              }
              ?>
