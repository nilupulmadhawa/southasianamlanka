...
if (!(isset($_POST["id"]) && $material = Material::find_by_id($_POST["id"]))) {
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($material->id)) ? 'Add' : 'Edit'; ?> Material</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formMaterial" action="proccess/material_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" id="txtId" name="id" value="<?php echo $material->id; ?>" />
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" placeholder="Name" id="txtName" name="name" value="<?php echo $material->name; ?>" required="">
                                </div>
...
//        });
    ...
    $("#btnSave").click(function () {
        var id = <?php echo ($material->id) ? 1 : 0; ?>;

        if (id) {
            if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "Material", "upd")) {
                FormOperations.confirmSave(validateForm(), "#formMaterial", id, null);
            }
        } else {
            if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "Material", "ins")) {
                FormOperations.confirmSave(validateForm(), "#formMaterial", id, null);
            }
        }
    });
    ...
    $("#btnDelete").click(function () {
        if (UserPrivileges.checkPrivilege("proccess/privileges_authenticate.php", "Material", "ins")) {
            FormOperations.confirmDelete("#formMaterial");
        }
    });
