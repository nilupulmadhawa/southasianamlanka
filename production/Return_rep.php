    ...
    <div class="row content">
      ...
      <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;padding-top:5px;">
        ...
        <div class="row">
          <div class="col-sm-6">
            <!--form start-->
            <form role="form" method="post" action="ConnectionReturn_rep.php">
        ...
        <div class="col-sm-6" style="margin-top:24px;">
          <div class="col-sm-12" style="font-size:20px;">RETURN INVOICE ID: <b>
            <?php
      ...
      <div class="col-sm-6" style="margin-top:24px;padding-left:30px;">

        <form class="form-inline" action="ReturnSet_rep.php">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              while($row = mysqli_fetch_array($result)){
                ...
                echo "<td style='text-align:center;'>".$row['imei']."</td>";
                echo "<td style='text-align:center;'>".$row['imei2']."</td>";
                  ...
                  echo "<td style='text-align:center;'>Expired Item Return</td>";}
                    ...
                    echo "<td style='text-align:center;'>Damaged Item Return</td>";}
                      ...
                      echo "<td style='text-align:center;'>Item Return</td>";}
                        ...
                        echo "<td> <a href='DeleteReturn_rep.php?id=".$row[0]."'> DELETE </a></td></tr>";
                        echo "</tr>";
                      }
                      mysqli_close($conn);
                      ?>
