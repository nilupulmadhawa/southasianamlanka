...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;padding-top:10px;"> 
	  ...
	  <!--form start-->
	  <form class="form-inline" role="form" method="post" action="ReportTotalProduct.php">
	  ...
	  <div class="row" style="font-size:20px;margin-left:0px;"><a href="ReportTotalP.php" target="_blank">EXPORT</a></div>
	  <div class="row">
		 ...
		 <?php 
		  function multotal($mulID,$qty){
			...
			while($itemsteps <= $itemcount){
				$result = mysqli_query($conn,"SELECT * FROM item LIMIT $itemsteps ");
				while($row = mysqli_fetch_array($result)){
				...
				echo "<td style='text-align:right;color:red'>-".number_format($tempre,2)."</td>";
			...
			echo "<tr>";
				echo "<td></td>";
				echo "<td></td>";
				echo "<td style='text-align:center;'><b>SUB TOTAL</b></td>";
			...
			echo "<tr>";
				echo "<td></td>";
				echo "<td></td>";
				echo "<td style='text-align:center;'><b>RETURN TOTAL</b></td>";
