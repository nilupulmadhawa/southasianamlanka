      ...
      <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;padding-top:10px;">
        <div class="row">
          <div class="col-sm-5">
            ...
            <form class="form-horizontal" role="form" method="post" action="ConnectionUpdateRep.php">
              <div class="form-group">
                <label class="control-label col-sm-2" for="email">Customer:</label>
                <div class="col-sm-10">
                  <select class="form-control" name="product">
                    <?php include'connection.php'; $result = mysqli_query($conn, "SELECT * FROM cus_profile ORDER BY Customer_Code ASC");
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="pwd" >Rep:</label>
                <div class="col-sm-10">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                while($steps<=$count){
                  ...
                  $result = mysqli_query($conn,"SELECT * FROM cus_profile ORDER BY Customer_Code ASC LIMIT $steps ");
                  while($row = mysqli_fetch_array($result)){

                    $Name = $row['Name'];
                    $ItemCode = $row['Customer_Code'];
                    $Rep_Code = $row['Rep_Code'];

                  }
                  $name = "NULL";
                  $result = mysqli_query($conn,"SELECT * FROM user_profile WHERE Prof_ID = $Rep_Code ");
                  while($row = mysqli_fetch_array($result)){
                    $name = $row[1];

                  }
                  echo "<tr><td> ".$ItemCode." (".$Name.")</td>";
                  echo "<td>".$name."</td></tr>";
                  $steps = $steps + 1;
                }
                mysqli_close($conn);?>
