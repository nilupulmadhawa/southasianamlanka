            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th class="left">Item Code/Name</th>
              ...
              <tbody>
                <?php
                function CostPrice($ItemCode,$ItemName,$itemID){
                  ...
                  while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<td></td>";
                    echo "</tr>";
                    RetailLevel($row['ID'],$row['CostPrice']);
                  }
                  mysqli_close($conn);
                }
                function RetailLevel($multiID,$CostPrice){
                  include 'connection.php';
                  $result = mysqli_query($conn,"SELECT * FROM tbl_ret_final WHERE multiID = $multiID ");
                  while($row = mysqli_fetch_array($result)){
                    echo "<tr>";
                    echo "<td></td>";
                    echo "<td></td>";
                    echo "<td>".$row['RetPrice']."</td>";
                    $Precentage = $row['RetPrice'] - $CostPrice;
                    $Precentage = $Precentage/$row['RetPrice'];
                ...
                while($row = mysqli_fetch_array($result)){
                  ...
                  CostPrice($row['ItemCode'],$row['Name'],$row['Item_ID']);
