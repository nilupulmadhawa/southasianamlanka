...
if (!(isset($_POST["id"]) && $role = Role::find_by_id($_POST["id"]))) {
    $role = new Role();
}
?>
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title"><?php echo (empty($role->id)) ? 'Add' : 'Edit'; ?> Role</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/role_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="role.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
