    ...
    <div class="row content">
      ...
      <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;">
        ...
        <div class="col-sm-12 col-md-offset-10">
          ...
          <!-- <a href='PrintInventory.php' target="_blank"><img src='images/print.png' width='50' height='50'> -->
          <!-- <p style="margin-left:-10px;">Print Report</p></a> -->
        </div>
        <!-- <div class="col-sm-12">
        <select onchange="showUser(this.value)" class="form-control">
        <option value="1">Print With Zero Values</option>
        <option value="2">Print Without Zero Values</option>
      </select>
    </div> -->
    <div id="txtHint"></div>
    <div class="col-sm-12" style="font-size:35px;text-align:center;"><b>MAIN STOCK REPORT</b></div>
    <div class="col-sm-12">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          while($rowcount>=$steps){
            ...
            $catsutot = 0;
            echo "<tr style='background-color:purple;color:white;'><td style='text-align:left;'>---</td><td style='font-size:15px;color:white;'><b>".$catname."</b></td><td style='text-align:center;'>---</td></tr>";
            ...
            while($row = mysqli_fetch_array($result)){
              ...
              if($row[6] == $qty){
                ...
                echo "<td style='color:orange;'>".$row[2]."</td>";


                echo "<td style='color:orange;text-align:center;'>".mainitemcount($row[0]) ."</td>";
                ...
                echo "<td style='color:red;text-align:center;'>".mainitemcount($row[0])."</td>";
                // echo "<td style='color:orange;text-align:right;'>".number_format($totalc,2)."</td>";
                echo "</tr>";
                $catsutot = $catsutot + $totalc;
              }
                ...
                echo "<td style='text-align:center;'>".mainitemcount($row[0]) ."</td>";
