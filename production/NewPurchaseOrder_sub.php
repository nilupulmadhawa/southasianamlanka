      ...
      <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;">
        ...
        <div class="row">
          <div class="col-sm-6 text-left" style="padding-bottom:5px;">
            ...
            <form role="form" method="post" action="ConnectionNewPurchaseOrder_sub.php">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="company">                  
                  <?php include'connection.php'; $result = mysqli_query($conn, "SELECT * FROM company WHERE ID > 2 ");
