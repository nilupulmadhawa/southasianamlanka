    ...
    <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;">
      <div class="row">
        <div class="col-sm-5" style="margin-top:5px;">
         ...
         <form class="form-horizontal" role="form" method="post" action="ConnectionChangeCustomerName.php">
          <div class="form-group">
            <label class="control-label col-sm-2" for="email">Customer:</label>
            <div class="col-sm-10">
              <select class="form-control" name="product">
                  <?php include'connection.php'; $result = mysqli_query($conn, "SELECT * FROM cus_profile WHERE CompanyID = $company ORDER BY Name ASC");
      ...
      <div class="col-sm-7" style="margin-top:5px;margin-bottum:5px;border:1px solid;border-radius:15px;height:550px;overflow:auto;">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <?php include'connection.php';
                ...
                $result = mysqli_query($conn,"SELECT Name FROM cus_profile WHERE CompanyID = $company ORDER BY Name ASC ");
                while($row = mysqli_fetch_array($result)){
                  GLOBAL $Name;
