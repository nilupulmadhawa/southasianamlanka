              ...
              <tbody>
                ...
                if( isset($_POST['Rep']) && isset($_POST['dtpFrom']) && isset($_POST['dtpTo']) ){
                  ...
                  foreach ($period as $key => $value) {
                    ...
                    if($_POST['Rep'] == 0){
                      $invoice_datas = Invoice::find_all_for_date_all($value->format('Y-m-d'));
                    }else{
                      $invoice_datas = Invoice::find_all_by_rep_date($value->format('Y-m-d'),$_POST['Rep']);
                    ...
                    foreach( $invoice_datas as $data ){
                      ...
                      echo "<td style='border-bottom:1px solid;padding-top:3px;text-align:center;'>".$data->code."</td>";
                    ...
                    if($_POST['Rep'] == 0){
                      $return_datas = ProductReturn::find_all_dates_all();
                    }else{
                      $return_datas = ProductReturn::find_all_date($value->format('Y-m-d'));
                    }

                    foreach( $return_datas as $data ){
                      foreach( ProductReturnInvoice::find_all_by_product_return_id($data->id) as $datas ){
                        ...
                        $date = $dt->format('Y-m-d');
                          ...
                          echo "<td style='width:25px;padding-bottom:3px;border-bottom:1px solid;padding-top:3px;'>".$line.") </td>";
                          echo "<td style='border-bottom:1px solid;padding-top:3px;'>".$data->date_time."</td>";
                          echo "<td style='border-bottom:1px solid;padding-top:3px;text-align:center;'>".$retID."</td>";

                          echo "<td style='text-align:right;padding-right:15px;border-bottom:1px solid;padding-top:3px;'> (".number_format($datas->return_amount,2).") </td>";
