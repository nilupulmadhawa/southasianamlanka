      ...
      <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;padding-top:10px;">
        <div class="row">
          <div class="col-sm-5">
            ...
            <form class="form-horizontal" role="form" method="post" action="ConnectionUpdateCategory.php">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select class="form-control" name="cat">
                    <?php include'connection.php'; $result = mysqli_query($conn, "SELECT * FROM category WHERE CompanyID = $company ORDER BY Category ASC");
                    while($row = mysqli_fetch_array($result)){
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                while($steps<=$count){
                  ...
                  $result = mysqli_query($conn,"SELECT Name,Category_Cat_ID FROM item WHERE CompanyID = $company ORDER BY Name ASC LIMIT $steps ");
                  while($row = mysqli_fetch_array($result)){
                    GLOBAL $CatID,$Name;
                  ...
                  $result = mysqli_query($conn,"SELECT Category FROM category WHERE CompanyID = $company AND Cat_ID = $CatID ");
                  while($row = mysqli_fetch_array($result)){
                    GLOBAL $name;
                    $name = $row[0];
