...
<body style="background-color:#e3e3e3;">
  ...
  <div class="container-fluid text-center">
    ...
    <div id="txtHint"></div>
    <div class="col-sm-12" style="font-size:35px;text-align:center;"><b>SUB STOCK REPORT</b></div>
    <div class="col-sm-12">
          ...
          while($rowcount>=$steps){
            ...
            while($row = mysqli_fetch_array($result)){
              ...
              if($row[6] == $qty){
                ...
                echo "<td style='color:orange;text-align:center;'>".subitemcount($row[0]) ."</td>";
                ...
                echo "<td style='color:red;text-align:center;'>".subitemcount($row[0])."</td>";
                // echo "<td style='color:orange;text-align:right;'>".number_format($totalc,2)."</td>";
                echo "</tr>";
                $catsutot = $catsutot + $totalc;
              }
                ...
                echo "<td style='text-align:center;'>".subitemcount($row[0]) ."</td>";
