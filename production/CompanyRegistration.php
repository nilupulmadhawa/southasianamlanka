...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" style="margin-top:10px;background-color: #F8F8F8;padding-top:10px;"> 
      ...
      <div class="col-sm-6">
        <!--start of the form-->
        <form class="form-horizontal" role="form" action="ConnectionCompany.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2">Contact Details:</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Contact Details" name="Contact">
                      </div>
                    </div>
