...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" style="margin-top:10px;background-color: #F8F8F8;"> 
      ...
      <!--start of the form-->
       <form role="form" method="post" action="ConnectionNewInvoiceShop.php">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="product" autofocus="on" onchange="showUser(this.value)"  >
            <?php 
            $result = mysqli_query($conn, "SELECT * FROM item WHERE  CompanyID = $company ORDER BY ItemCode ASC");
            while($row = mysqli_fetch_array($result)){
    ...
    <div  id="txtHint1"></div>
      ...
      <div class="col-sm-6">
        <div style="margin-top:25px;">
          <p>Invoice Number: <b><?php if(!isset($_SESSION['invoice'])){echo "No Selected Invoice Number";}else{$invoice =  $_SESSION['invoicenumber']; $invoice = sprintf("%04d", $invoice);echo $invoice;} ?></b></p>
    ...
    <button type="submit" class="btn btn-primary" onClick="document.location.href='ConnectionSubmitInvoiceShop.php'">SUBMIT THE INVOICE</button>
    </div>
    </div>
    <div class="col-sm-2 sidenav">
