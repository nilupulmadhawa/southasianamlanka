        ...
        <li><a><i class="fa fa-shopping-cart"></i> Product Management <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            ...
            if(Functions::check_privilege_by_module_action("Batch","view")){
              ...
              echo '<li><a href="batch_price_update.php">Batch Price Update</a></li>';
            }
            ?>
        ...
        <li><a><i class="fa fa-archive"></i> Inventory Management <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            ...
            if(Functions::check_privilege_by_module_action("ProductGRN","view")){
              ...
              echo '<li><a href="stock_adjustment_damage.php">Damage Transfer</a></li>';
            }
        ...
        <li><a><i class="fa fa-dollar"></i> Sales And Payment <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            ...
            if(Functions::check_privilege_by_module_action("Return","ins")){
              ...
              echo '<li><a href="invoice_write_off.php">Invoice Wirte off</a></li>';
            ...
            if(Functions::check_privilege_by_module_action("Payment","view")){
              ...
              echo '<li><a href="over_payments_settlement.php">Over Payments Settlement</a></li>';
              echo '<li><a href="invoice_write_off_management.php">Invoice Wirte off Management</a></li>';
        ...
        <li><a><i class="fa fa-truck"></i>Deliverer Management <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            ...
            if(Functions::check_privilege_by_module_action("Deliverer","ins")){
              ...
              echo '<li><a href="deliverer_status.php">Delivery Status Update</a></li>';
            }
            ...
            if(Functions::check_privilege_by_module_action("Deliverer","view")){
              echo '<li><a href="deliverer_management.php">Deliverer Management Detailed Report</a></li>';
              echo '<li><a href="deliverer_status_report.php">Delivery Status Detailed Report</a></li>';
        ...
        <li><a><i class="fa fa-paperclip"></i>Reports<span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu">
            ...
            if(Functions::check_privilege_by_module_action("Invoice","view")){
              ...
              echo '<li><a href="outstanding_invoice_customers_rep_wise.php">Rep Wise Outstanding</a></li>';
              echo '<li><a href="outstanding_invoice_customers_cus_wise.php">Customer Wise Outstanding</a></li>';
            }
            ?>
            ...
            if(Functions::check_privilege_by_module_action("Invoice","view")){
              ...
              echo '<li><a href="price_list.php">Price List</a></li>';
            }

            if(Functions::check_privilege_by_module_action("Invoice","view")){
              // echo '<li><a href="sales_report_summary.php">Sales Summary</a></li>';
              echo '<li><a href="sales_report_summary_rep.php">Sales Summary Rep Wise</a></li>';
            }

            if(Functions::check_privilege_by_module_action("Invoice","view")){
              echo '<li><a href="invoice_detail_report.php">Invoice Costing</a></li>';
              // echo '<li><a href="non_collected_invoice.php">Non Collected Invoice Report</a></li>';
              echo '<li><a href="brand_wise_sales_report.php">Brand Wise Sales Report</a></li>';
            ...
            if(Functions::check_privilege_by_module_action("Inventory","view")){
              ...
              echo '<li><a href="item_wise_detailed_report_new_update.php">Item Wise Detailed Report</a></li>';
              echo '<li><a href="item_wise_detailed_report_new_testing.php">Item Wise Detailed Report New</a></li>';
              // echo '<li><a href="item_wise_detailed_report_new.php">Item Wise Detailed Report New</a></li>';
              echo '<li><a href="item_wise_detailed_report_specific.php">Item Wise Detailed Report (for specific date)</a></li>';
            }

            if(Functions::check_privilege_by_module_action("Inventory","view")){
              // echo '<li><a href="stock_report.php">Stock Report</a></li>';
              echo '<li><a href="stock_report_new.php">Stock Report</a></li>';
              echo '<li><a href="stock_report_brand.php">Brand Wise Stock Report</a></li>';
            }
            if(Functions::check_privilege_by_module_action("Inventory","view")){
            ...
            if(Functions::check_privilege_by_module_action("Inventory","view")){
              ...
              echo '<li><a href="initial_inventory.php">Initial Inventory Report</a></li>';
            }
