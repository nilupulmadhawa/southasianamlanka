                        ...
                        <table id="datatable-responsive" class="" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($users as $user) {
                                    $cheques = Cheque::find_by_sql("SELECT c.* FROM payment_cheque pc
                                                INNER JOIN payment_invoice pi ON pi.payment_id = pc.payment_id
                                                INNER JOIN invoice i ON i.id = pi.invoice_id
                                                INNER JOIN cheque c ON c.id = pc.cheque_id
