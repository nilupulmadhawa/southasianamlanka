...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;">
      ...
      <!--start of the form-->
       <form role="form" method="post" action="ConnectionNewPurchaseOrder.php">
         ...
         <input type="hidden" class="form-control" name="potype" value="2" required>

        <div class="form-group">
          <label>Date:</label>
          <input type="text" class="form-control" id="datepicker" name="podate" placeholder="Date" autocomplete="off" required>
        </div>
        <div class="form-group">
          <label>PO ID:</label>
