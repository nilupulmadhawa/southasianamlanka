...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    include 'connection.php';
		...
		<div class="col-sm-12">
		<p>Age Balance Listing All Customers As At : <?php echo date("Y-M-d"); ?></p>
		</div>
		</div>
		<div class="col-sm-6" style="text-align:right;padding-right:150px;padding-top:30px;font-size:25px;">
			<a href="OutstandingPrint.php" class="btn btn-info btn-block" role="button" target="_blank" >Print</a>
		</div>
         <!--form end-->
