    ...
    <div class="col-sm-8 text-left" style="margin-top:10px;background-color: #F8F8F8;"> 
      <div class="row">
        <div class="col-sm-5">
         ...
         <form class="form-horizontal" role="form" method="post" action="ConnectionSupplierDueDate.php">
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" placeholder="Credit Period" name="ddate">
            </div>
          </div>
