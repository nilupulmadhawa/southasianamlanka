  ...
  <div id="dvContents" style="margin-left:10px;">
    <div class="container-fluid text-center">
      ...
      <div class="row" style="padding-left:15px;padding-right:25px;">
          ...
          <tbody>
            ...
            while($row = mysqli_fetch_array($result)){
              ...
              if($row[6]>0){
                ...
                echo "<td style='font-size:10px;width:88px;margin-top:2px;text-align:right;'>0%</td>";
              }
            ...
            <div style="clear:both;margin-top:25px;text-align:left;font-size:10px;">
              ...
              <div style="width:700px;">
                ...
                <div style="width:600px;margin-left:20px;">
                  ...
                  $outtotal = 0;
                  $count = 0;
                  $result = mysqli_query($conn,"SELECT * FROM invoice WHERE Customer_id = $cusid AND status = '0' AND invoice > 0 ORDER BY InvDate ASC ");
                  while($row = mysqli_fetch_array($result)){
                    GLOBAL $count;
                    $count = $count +1;
                  }
                  ...
                  while($steps<=$count){
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM invoice WHERE Customer_id = $cusid AND status = '0' AND invoice > 0 ORDER BY InvDate ASC LIMIT $steps");
                    while($row = mysqli_fetch_array($result)){
        ...
        <div style='float:left;width:700px;margin-left:10px;font-size:7px;text-align:right;'>Designed and Maintained By OSRAM Tec. [Contact:0777 558717/ 0755 155155]</div>
        <div/>
