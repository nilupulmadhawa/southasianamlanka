...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" style="margin-top:10px;background-color: #F8F8F8;"> 
      ...
      <!--start of the form-->
       <form role="form" method="post" action="ConnectionNewCustomerCat.php">
    ...
    <div class="row">
      ...
      <!--start of the tabele--><div style="height:150px;overflow:auto;">
        ...
        <th class="tablecol3">Catagory</th>
         ...
         <tbody>
            <?php include 'connection.php'; $result = mysqli_query($conn,"SELECT * FROM supplier_cat ORDER BY ID ASC");
