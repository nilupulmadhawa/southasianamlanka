...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;">
      ...
      <!--start of the form-->
       <form role="form" method="post" action="ConnectionNewCategory.php">
      ...
      <!--start of the tabele--><div style="height:550px;overflow:auto;">
        ...
        <th class="tablecol3 text-center">Catagory</th>

        </tr>
      </thead>
         <tbody>
            <?php $company = $_SESSION['company']; include 'connection.php'; $result = mysqli_query($conn,"SELECT * FROM category ORDER BY Category ASC");
