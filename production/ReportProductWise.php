...
<table class="table table-striped" style="font-size:12px;">
		<thead>
		  <tr>
			<th width='100px' style='text-align:left;'>Product Code</th>
			<th width='400px' style='text-align:left;'>Description</th>
		...
		<tbody>
		 ...
		 $company = $_SESSION['company'];
			...
			$invcount = 0;
				...
				echo "<td></td>";
				echo "<td></td>";
				echo "<td style='text-align:left;'>SUB TOTAL</td>";
			...
			echo "<tr>";
				echo "<td></td>";
				echo "<td></td>";
				echo "<td style='text-align:left;'>RETURN</td>";
