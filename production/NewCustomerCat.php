      ...
      <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;">
        <div class="row">
          <div class="col-sm-6 text-left">
            <!--start of the form-->
            <form role="form" method="post" action="ConnectionNewSupplierCat.php">
        ...
        <div class="row">
          ...
          <table class="table table-striped" width="100%" style="font-size:12px;">
            <thead>
              <tr>
                <th class="tablecol1">ID</th>
                <th class="tablecol3" style="text-align:center;">Catagory</th>

              </tr>
            </thead>
            <tbody>
              <?php include 'connection.php'; $result = mysqli_query($conn,"SELECT * FROM supplier_cat WHERE CompanyID = $company ORDER BY ID ASC");
