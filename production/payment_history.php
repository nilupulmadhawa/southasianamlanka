                                ...
                                <div class="tab-content">
                                    <div id="div1" class="tab-pane fade in active">
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12 ">
                                            ...
                                            <div class="ui-widget">
                                                <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" id="cmbFilter" name="filter_id" required="">
                                    ...
                                    <div id="div2" class="tab-pane fade">
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12 ">
                                            <label>From</label>
                                            <input type="text" class="form-control" placeholder="yyyy-mm-dd" id="dtpFrom" name="dtpFrom">
                                        </div>
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12 ">
                                            <label>To</label>
                                            <input type="text" class="form-control" placeholder="yyyy-mm-dd " id="dtpTo" name="dtpTo">
                                        </div>
                                    </div>
                                </div>
...
//
    ...
    function PrintDiv() {
        ...
        popupWin.document.write('<html><head><link href="../vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet"></head><body onload="window.print()"><br/><h3 style="text-align:center;">Payment History Report</h3><hr><br/><div>' + divToPrint.innerHTML + '</div></body></html>');
...
//        alert(from+" / "+to);
    ...
    function loadPaymentsByDateRange(from, to) {
        if (from && to) {
            $.ajax({
                url: 'proccess/payment_history_by_date_range_process.php?from=' + from + '&to=' + to +'&filter=true'
            }).done(function (data) { // data what is sent back by the php page
