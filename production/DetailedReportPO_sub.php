            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                while($steps<=$count){
                  ...
                  $result = mysqli_query($conn,"SELECT * FROM po_sub ORDER BY ID DESC LIMIT $steps");
                  while($row = mysqli_fetch_array($result)){
                  ...
                  echo "<tr><td><a href='DetailedReportPOExtend_sub.php?id=".$pid."'>".$poid."</a></td>";
                  ...
                  echo "<td style='text-align:center;'> <a href='DeletePO.php?id=".$pid."'> DELETE </a></tr>";
                }
