  ...
  <div class="container-fluid text-center">
    <div class="row content">
      ...
      if(isset($_POST['name'])){
        ...
        $sql = "INSERT INTO tbl_route (RouteName,CompanyID) VALUES ('$routeName',$company)";
      ...
      <div class="col-sm-10 text-left" style="margin-top:10px;background-color: #F8F8F8;">
        <div class="row">
          <div class="col-sm-6 text-left">
            <!--start of the form-->
            <form role="form" method="post" action="NewRoute.php">
        ...
        <div class="row">
          ...
          <table class="table table-striped" width="100%" style="font-size:12px;">
            ...
            <tbody>
              <?php include 'connection.php'; $result = mysqli_query($conn,"SELECT * FROM tbl_route WHERE CompanyID = $company ");
              while($row=mysqli_fetch_array($result)) {
                echo "<tr><td>".$row[1]."</td><td><a href='NewRoute.php?delID=".$row[0]."'>DELETE</a></td></tr>";
              }
              ?>
            </tbody>
          </table>
