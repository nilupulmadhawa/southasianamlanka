...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","livecommision.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
    ...
    <div class="col-sm-8 text-left" style="margin-top:10px;"> 
      <div class="row">
        <div class="col-sm-6">
          ...
          <form class="form" role="form" method="post" action="DeliveryAllocator.php" style="margin-left:7px;">
      ...
      <div class="col-sm-12 text-left" style="height:500px;overflow:auto;">
      <hr/>
