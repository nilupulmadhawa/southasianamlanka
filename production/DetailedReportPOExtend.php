            ...
            <table class="table table-striped" width="100%" style="font-size:12px;">
              <thead>
                <tr>
                  ...
                  <th class="tablecol3">Imei 1</th>
                  <th class="tablecol3">Imei 2</th>
              ...
              <tbody>
                ...
                if(isset($_GET['id'])){
                  $inv =  $_GET['id'];
                  $result = mysqli_query($conn,"SELECT * FROM po WHERE ID = $inv ");
                  ...
                  $SubCount = 0;
                  $result = mysqli_query($conn,"SELECT * FROM sub_po WHERE PoID = '$invoice' ");
                  while($row = mysqli_fetch_array($result)){
                    GLOBAL $SubCount;
                    $SubCount =  $SubCount + 1;
                  }
                  ...
                  while($steps<=$SubCount){
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM sub_po WHERE PoID = '$invoice' LIMIT $steps");
                    while($row = mysqli_fetch_array($result)){
                  ...
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td>TOTAL</td><td>Rs. ".number_format($pototal,2)."</td></tr>";
