        ...
        <?php if(isset($_SESSION['errormessage'])){ ?>
          ...
          <?php if(isset($_SESSION['successmessage'])){ ?>
            ...
            <div class="row">
              ...
              <form method="post" action="AddToSubStock_rep.php">
                <div class="form-group">
            ...
            <div class="col-sm-7" style="border:1px solid;padding:5px;height:250px;overflow:auto;box-shadow: 5px 10px #888888;">
              ...
              <div class="col-sm-12">
                <label style="background-color:teal;padding:5px;color:white;">AVAILABLE STOCK</label>
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM inventory_sub WHERE issued = 0 ");
                    while($row = mysqli_fetch_array($result)){
                      echo "<tr>";
                      echo "<td>".$row['imei']."</td>";
            ...
            <div class="col-sm-12">
              <div style="margin-top:25px;">
                ...
                <p>GRN Number: <b><?php include 'connection.php'; if(isset($_SESSION['podi'])){ $poid = $_SESSION['podi']; $result = mysqli_query($conn,"SELECT * FROM po_rep WHERE ID = $poid"); while($row = mysqli_fetch_array($result)){ $pid = $row['PoID'];} echo $pid;} ?> </b></p>
              ...
              <button type="submit" class="btn btn-primary" onClick="document.location.href='ConnectionSubmitPo_rep.php'">SUBMIT GRN</button>
            </div>
          </div>
            ...
            <table class="table table-striped" width="100%" style="font-size:12px;">
              ...
              <tbody>
                ...
                if(isset($_GET['delTemp'])){
                  $delID = $_GET['delTemp'];
                  $sql = "DELETE FROM temp_po_rep WHERE ID = $delID ";
                ...
                if(isset($_SESSION['podi'])){
                  ...
                  while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<td>".$row['imei']."</td>";
                    echo "<td>".$row['imei2']."</td>";
                    echo "<td><a href='NewPurchaseOrderSecond_rep.php?delTemp=".$row[0]."' class='btn btn-xs btn-primary'>DELETE</a></td>";
                    echo "</tr>";
                  }
                }
                ?>
